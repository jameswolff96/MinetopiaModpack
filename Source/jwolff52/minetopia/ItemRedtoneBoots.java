...
public class ItemRedtoneBoots extends ItemArmor implements IArmorTextureProvider{

	public ItemRedtoneBoots(int par1,EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
