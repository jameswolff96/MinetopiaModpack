...
public class ItemLapisLeggings extends ItemArmor implements IArmorTextureProvider{

	public ItemLapisLeggings(int par1,EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
