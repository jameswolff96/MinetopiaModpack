...
public class ItemLapisBoots extends ItemArmor implements IArmorTextureProvider{

	public ItemLapisBoots(int par1,EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
