...
public class ItemObsidianBoots extends ItemArmor implements IArmorTextureProvider{

	public ItemObsidianBoots(int par1,EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
