...
public class ItemLapisChestplate extends ItemArmor implements IArmorTextureProvider{

	public ItemLapisChestplate(int par1,EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
